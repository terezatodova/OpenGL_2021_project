...
bool ShaderProgram::add_fragment_shader(const std::filesystem::path& file_name) {
    return add_shader(GL_FRAGMENT_SHADER, file_name);
}

bool ShaderProgram::add_compute_shader(const std::filesystem::path& file_name) {
    return add_shader(GL_COMPUTE_SHADER, file_name);
}

bool ShaderProgram::add_geometry_shader(const std::filesystem::path& file_name) {
    return add_shader(GL_GEOMETRY_SHADER, file_name);
}

bool ShaderProgram::add_tess_control_shader(const std::filesystem::path& file_name) {
    return add_shader(GL_TESS_CONTROL_SHADER, file_name);
}

bool ShaderProgram::add_tess_evaluation_shader(const std::filesystem::path& file_name) {
    return add_shader(GL_TESS_EVALUATION_SHADER, file_name);
}
