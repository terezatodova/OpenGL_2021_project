...
class OpenGLManager {
  ...
  public:
     ...
     */
    void init(int width, int height, std::string title, int major, int minor);
     ...
     */
    void disable_resize() { glfwSetWindowAttrib(window, GLFW_RESIZABLE, GLFW_FALSE); }
     ...
     */
    void set_multisampling_per_pixel(int samples) { samples_per_pixel = samples; }
};
